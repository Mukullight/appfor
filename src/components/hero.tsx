...
import streetVideo from "@/video/street.mp4";
import posterImage from "@/images/pexels-pixabay-219692.jpg";
        ...
        <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              <motion.h1 className="banner-title text-white" variants={itemVariants}>Boost your business one plate at a time.</motion.h1>
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6" variants={itemVariants}>
                Using smart AI to create a thriving resturant 
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Easy sign up</h3>
            <p className="text-gray-600 text-xs md:text-sm">Create your resturant profile in minutes and start connecting with local diners instantly</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Targeted diner  search</h3>
            <p className="text-gray-600 text-xs md:text-sm">find nearby diners by city, state or intrests to craft personalized offers that drive traffic</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">AI powered offers</h3>
            <p className="text-gray-600 text-xs md:text-sm">Use ai to create compelling offers, preview them, and send via email or sms to attract diners.</p>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>;
